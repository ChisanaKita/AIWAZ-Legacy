...
> Now The Server owners Can Use Command `/install` To Automatically Build A World In Discord Using The (Majutsu No Index world) Setting.
- Add: install.js File for Process And Executing The Functions
